...
namespace Gaten.GameTool.osu.ConvertRanking
{
    public class MyPage
    {
        ...
        public string medal;
        public string pp;
        public string silverSsCount;
        public string goldSsCount;
        public string silverSCount;
        public string goldSCount;
        public string aCount;
        public string worldRank;
        public string countryRank;
        public string registDate;
        public string onlineStatus;
        public string playDevice;
        ...
        public List<TopPerformance> topPerformances = new List<TopPerformance>();
        public List<FirstPlaceAchievement> firstPlaceAchievements = new List<FirstPlaceAchievement>();
        public List<MostPlayBeatmap> mostPlayBeatmaps = new List<MostPlayBeatmap>();
