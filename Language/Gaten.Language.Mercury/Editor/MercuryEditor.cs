...
namespace Gaten.Language.Mercury.Editor
{
    public class MercuryEditor
    {
        ...
        {
            using (Stream? s = typeof(MainWindow).Assembly.GetManifestResourceStream("Gaten.Language.Mercury.Editor.MercuryHighlighting-Light.xshd"))
            {
            ...
            using (Stream? s = typeof(MainWindow).Assembly.GetManifestResourceStream("Gaten.Language.Mercury.Editor.MercuryHighlighting-Dark.xshd"))
            {
                using XmlReader reader = new XmlTextReader(s);
