namespace Gaten.Net.Math
{
    public class SineWave : IWave
    {
        ...
        public SineWave(int sampleRate, double frequency, double amplitude, double duration)
        {
            ...
            {
                Magnitudes.Add(amplitude * System.Math.Sin(2 * System.Math.PI * i * frequency / sampleRate));
            }
        }
    }
}
