namespace Gaten.Game.Dung_Eo_Ri.GameRule
{
    public class Dungeon
    {
        ...
        public Mob BossMob { get; set; } = default!;
        public List<DungeonLevel> DungeonLevels { get; set; } = new();
        public List<Equip> RewardEquips { get; set; } = new();
        public Mob CurrentMob { get; set; } = default!;
