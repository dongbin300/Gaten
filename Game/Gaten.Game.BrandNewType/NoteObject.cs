...
namespace Gaten.Game.BrandNewType
{
    internal class Note
    {
        ...
        public Note() : this(0, string.Empty)
        {
    ...
    internal class NoteObject
    {
        ...
        public void ToNote(string str)
        {
            ...
            foreach (char c in strLetters)
            {
                ...
                KoreanSentence? h = new(c);

                // Area 개수가 2개 이하이면 8비트
                Hangeul? separatedHangeul = h.Separate(KoreanSeparateOption.Heavy).FirstOrDefault() ?? new Hangeul { Area1 = "ㄱ", Area2 = "ㅏ" };
        ...
        public int Hit(Keys key, Rail rail, bool shiftMode)
        {
